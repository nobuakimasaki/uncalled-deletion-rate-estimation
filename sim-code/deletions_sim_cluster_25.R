...
file.name0.25 <- paste0("res.obsPi.boot.", paste(theta01, theta02, theta10, theta12, theta20, theta21, gamma, sep = '.'),
                        ".p.", 0.25,
                        ".n_trios.", n_trios,
                        ".n_pos.", n_pos*n_reps,
                        ".iter_optim", 10000, ".",
                        iter.number, ".rds")
res0.25 <- mclapply(num.iter.vec, do_one, 
                    n_trios = n_trios, 
                    n_pos = n_pos, 
                    n_reps = n_reps,
                    p = 0.25, 
