...
file.name0.05 <- paste0("res.obsPi.boot.", paste(theta01, theta02, theta10, theta12, theta20, theta21, gamma, sep = '.'),
                        ".p.", 0.05,
                        ".n_trios.", n_trios,
                        ".n_pos.", n_pos*n_reps,
                        ".iter_optim", 10000, ".",
                        iter.number, ".rds")
res0.05 <- mclapply(num.iter.vec, do_one, 
                    n_trios = n_trios, 
                    n_pos = n_pos, 
                    n_reps = n_reps,
                    p = 0.05, 
