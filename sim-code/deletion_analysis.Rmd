...
p01 <- ggplot(point.est.01, aes(x = model, y = est., color = model)) + geom_beeswarm() +
  ...
  theme(text = element_text(size=15), axis.text.x=element_blank(), legend.position = c(0.87, 0.17), plot.title = element_text(hjust = 0.5)) + 
  scale_color_brewer(palette = "Set1") + labs(x = "Model", y = "Point estimate", title = "MAF interval: (0.01, 0.015]", color = "Model")
...
p05 <- ggplot(point.est.05, aes(x = model, y = est., color = model)) + geom_beeswarm() +
  ...
  theme(text = element_text(size=15), axis.text.x=element_blank(), legend.position = c(0.87, 0.17), plot.title = element_text(hjust = 0.5)) + 
  scale_color_brewer(palette = "Set1") + labs(x = "Model", y = "Point estimate", title = "MAF interval: (0.05, 0.055]", color = "Model")
...
p25 <- ggplot(point.est.25, aes(x = model, y = est., color = model)) + geom_beeswarm() +
  ...
  theme(text = element_text(size=15), axis.text.x=element_blank(), legend.position = c(0.87, 0.17), plot.title = element_text(hjust = 0.5)) + 
  scale_color_brewer(palette = "Set1") + labs(x = "Model", y = "Point estimate", title = "MAF interval: (0.25, 0.255]", color = "Model")
...
p49 <- ggplot(point.est.49, aes(x = model, y = est., color = model)) + geom_beeswarm() +
  ...
  theme(text = element_text(size=15), axis.text.x=element_blank(), legend.position = c(0.87, 0.17), plot.title = element_text(hjust = 0.5)) + 
  scale_color_brewer(palette = "Set1") + labs(x = "Model", y = "Point estimate", title = "MAF interval: (0.49, 0.495]", color = "Model")
