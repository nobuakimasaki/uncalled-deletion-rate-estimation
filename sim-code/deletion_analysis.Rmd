...
p01 <- ggplot(point.est.01, aes(x = model, y = est., color = model)) + geom_beeswarm() +
  geom_hline(data = trueInt, aes(yintercept = as.numeric(Int)), color = "black", linetype = 'dotted') + facet_wrap(~param., scales = "free", labeller = label_parsed) + theme_bw() +
  ...
  theme(text = element_text(size=18), axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank(), legend.position = "none", legend.text=element_text(size=12), legend.box.background = element_rect(color = "black"), legend.box.margin = margin(t = 1, l = 1), plot.title = element_text(hjust = 0.5)) 
...
p05 <- ggplot(point.est.05, aes(x = model, y = est., color = model)) + geom_beeswarm() +
  ...
  theme(text = element_text(size=18), axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.x=element_blank(), axis.title.y=element_blank(), legend.position = c(1, 0), legend.justification = c(1,0), legend.title = element_text(size=18), legend.text=element_text(size=18), legend.box.background = element_rect(color = "black"), legend.box.margin = margin(t = 1, l = 1), plot.title = element_text(hjust = 0.5)) 
